...
```
curl https://raw.githubusercontent.com/Maheshwar5/docker-install-commands/master/docker-install.sh | sudo bash
```
* Clone this repo.
```
git clone https://github.com/Maheshwar5/k8s-install.git
```
